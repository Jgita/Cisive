app.controller('windshieldUploadPhotoInspectorController', [
    '$scope',
    '$http',
    '$q',
    'globalService',
    ...
    function ($scope, $http, $q, globalService, $uibModal, toastr, $httpParamSerializerJQLike, $state, $css, $rootScope, CONSTANTS) {
        ...
        function uploadPhotos() {
            ...
            const winInspectorPhotoPromis = new Promise(function (resolve, reject) {
            ...
            winInspectorPhotoPromis.then(function (response) {
                $rootScope.isProcessShow(false);
        ...
        $scope.photoTab = {
            'fullWindshieldPhoto': {
                ...
                route: 'inspectionPage.WindshieldUploadPhotoInspector.fullPhoto'
            },
            'damagePhoto': {
                id: '3',
