// // Backward compatibility angular.module('ngSignaturePad', ['signature']);
    ...
    function ($interval, $timeout, $window) {
      ...
      return {
        ...
        template: '<div class="signature" style="width: 100%; max-width:{{width}}px; height: 100%; ' +
            ...
            'seup="onMouseup()" ng-mousedown="notifyDrawing({ drawing: true })" ng-mouseleave' +
            '="onMouseup()"></canvas></div>',
        scope: {
          accept: '=?',
          clear: '=?',
          undo: '=?',
        ...
        controller: [
          ...
          function ($scope, $rootScope) {
            ...
            $rootScope.ondrawEndPoint = false;
        ...
        link: function (scope, element, attrs) {
          ...
          var calculateScale = function () {
            ...
            // canvas.style.height = "198px"; canvas.style.width = Math.round(newWidth) +
            // "px";
